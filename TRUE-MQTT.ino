...
// WiFi konfigurazioa
const char* ssid = "WIFIA"; //Zuen Wifia
const char* password = "pasahitza"; //Zuen Wifiaren pasahitza

// MQTT konfigurazioa
const char* mqtt_server = "192.168.1.100";  //Zuen ioMBianaren IP helbidea
